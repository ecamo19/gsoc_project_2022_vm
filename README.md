...
```mermaid
  graph TD;
      ...
      get_parameter_samples_1--> input_get_ensemble_1[pft.samples];  
      get_parameter_samples_2--> input_get_ensemble_1[ensemble.size];
      get_parameter_samples_3--> input_get_ensemble_1[param.names];
