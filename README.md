...
```mermaid
  graph TD;
      ...
      write.ensemble.configs-->output_write_ensemble_1[list, containing $runs = data frame of runids];
      ...
      write.ensemble.configs-->output_write_ensemble_4[writes sensitivity analysis configuration files as a side effect];
