...
#ssh -nNf -o ControlMaster=yes -S /tmp/ecalder1_gsoc_4 ecalder1@geo.bu.edu


# Step 2: access tunnel
scc_host <- list(name = "geo.bu.edu", tunnel = "/tmp/ecalder1_gsoc_4")
...
# Read settings file -----------------------------------------------------------
settings <- PEcAn.settings::read.settings("/home/carya/gsoc/xml_files/pecan_run_2.xml") 

# Port  ------------------------------------------------------------------------
#ssh -L 5433:localhost:5432 carya@localhost:6480



# Configure settings -----------------------------------------------------------
settings$outdir <- file.path('./gsoc/pecan_runs/run_2/')
